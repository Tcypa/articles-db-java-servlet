...
public class FormHandlerServlet extends HttpServlet {
    ...
    public static JSONArray searchArticles(String author, String year, String tags, String theme,
                ...
                for (int i = 0; i < allArticles.length(); i++) {
                    ...
                    if ((author == null || author.isEmpty() || article.getString("author").contains(author))
                            ...
                            && (tags == null || tags.isEmpty()
                                    || areAllElementsPresent(article.getString("tags"), tags))
                    ...
                    if (article.getString("id").equals(articleId)) {
                        if (deletefile) {
                            File fileToDelete = new File(
                                    servletContext.getRealPath(ARTICLE_FOLDER) + article.getString("fileName"));
                            fileToDelete.delete();
                        }
